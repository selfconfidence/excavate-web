  ...
  <el-dialog title="编辑" :visible.sync="dialogFormVisible">
    <el-form label-width="80px">
        ...
        <el-form-item label="任职方式">
          <el-radio v-model="pojo.type" label="0">全职</el-radio>
        <el-radio v-model="pojo.type" label="1">兼职</el-radio>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    eidFindList(){
    this.eidList = [{"id":1,"name":"阿里"},{"id":2,"name":"华为"},{"id":3,"name":"谷歌"},{"id":4,"name":"亚马逊"},{"id":5,"name":"神州"}]
    },
    handleSave() {
