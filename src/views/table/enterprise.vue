...
<el-input v-model="searchMap.name" placeholder="企业名称"></el-input></el-form-item>
  ...
  <el-dialog title="编辑" :visible.sync="dialogFormVisible">
    <el-form label-width="80px">
        ...
        <el-form-item label="是否热门">
          <el-switch v-model="pojo.ishot" inactive-value="0"  active-value="1"></el-switch>
           </el-form-item>
  ...
  <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        ...
        <el-form-item label="URL"><el-input v-model="pojo.url">
...
export default {
  ...
  methods: {
    ...
    handleAvatarSuccess(res, file) { //调用后的钩子函数
        this.imageUrl = URL.createObjectURL(file.raw);
        this.pojo.logo=this.imageUrl;
      },
      beforeAvatarUpload(file) { //调用前的钩子函数
